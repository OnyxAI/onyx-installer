    ...
    ui(new Ui::UpdateNotification)
{
    ...
    #endif
    QString appendURL = "<a href='https://onyxlabs.fr/fr/download/'><span style=\" text-decoration: underline; color:#51BC9B;\">https://onyxlabs.fr/fr/download/</span></a></p></body></html>";
